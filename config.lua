...
Config.AvailableJobs = {                                     -- Only used when not using qb-jobs.
    ...
    ['telco'] = { ['label'] = 'Technecien', ['isManaged'] = false }

}

Config.Cityhalls = {
    { -- Cityhall 1
        coords = vec3(-544.4, -203.64, 38.22),
        showBlip = true,
        blipData = {
            sprite = 487,
            display = 4,
        ...
        licenses = {
            ...
            -- No metadata: always listed at city hall (metadata = 'weapon' hid it while licences.weapon is false)
            ['weaponlicense'] = {
...
Config.Peds = {
    ...
    {
        model = 'u_m_m_bankman',
        coords = vec4(-544.4, -203.64, 37.22, 208.57),
